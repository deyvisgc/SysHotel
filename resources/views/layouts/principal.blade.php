...
<head>
    <meta charset="utf-8">
    <title>INGENIEROS Y ASOCIADOS IBERAM</title>
...
<section id="hero">
    <div class="hero-container">
        <div class="wow fadeIn">
            <div class="hero-logo">
                <img class="" src="img/logo.png" alt="Empresa">
            </div>

            <h1>INGENIEROS Y ASOCIADOS IBERAM S.A.C</h1>
            <h2>Nuestros <span class="rotating">clientes nos recomiendan</span></h2>
            <div class="actions">
                <a href="#about" class="btn-get-started">Empesar</a>
    ...
    <div class="container">
        ...
        <nav id="nav-menu-container">
            <ul class="nav-menu">
                ...
                <li><a href="{{url('login')}}">SISHOTEL</a></li>
            </ul>
        </nav>
        <!-- #nav-menu-container -->
    </div>
